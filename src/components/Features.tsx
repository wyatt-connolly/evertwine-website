...
export default function Features() {
  ...
  const features = [
    {
      icon: Calendar,
      title: "1. Sign Up",
      description: "Create your profile and set your interests",
    ...
    },
    {
      ...
      description: "Find local meetups that match your vibe",
    ...
    },
    {
      icon: MessageCircle,
      title: "3. Chat First",
      description: "Get to know people before meeting up",
      color: "from-green-500 to-green-600",
      mockup: "💬",
    },
    {
      icon: Users,
      title: "4. Meet & Connect",
      description: "Show up and make real friendships",
  ...
  return (
    <>
      ...
      {/* Separate Section for App Features */}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {[
                ...
                },
                {
                  ...
                  description: "Verified profiles and secure meetups",
                  mockup: "🛡️",
                  content:
                    "✅ ID Verified\n📸 Photo Matched\n⭐ 4.8 Rating\n🏆 Trusted Member",
                },
