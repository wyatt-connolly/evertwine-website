              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="text-lg font-semibold text-white mb-2">
                    Evertwine Raises $5M Series A
                  </h3>
                  <p className="text-gray-400 text-sm mb-2">
                    December 15, 2024
                  </p>
                  <p className="text-gray-300 text-sm">
                    Funding will accelerate product development and expand to
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    Evertwine expands to Austin, Seattle, Denver, and 7 other
                    major cities.
                  </p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    New partnerships with 100+ local venues to host community
                    events.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      &ldquo;Evertwine is revolutionizing how people connect in
                      the digital age&rdquo;
                    </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      &ldquo;The social app that&apos;s bringing back real-world
                      connections&rdquo;
                    </p>
                    <p className="text-gray-400 text-xs">Read more →</p>
                  </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      &ldquo;How Evertwine is solving the loneliness
                      epidemic&rdquo;
                    </p>
                    <p className="text-gray-400 text-xs">Read more →</p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Key facts and company information
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
